...
namespace UniversityManagementSystem.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public StudentsController(UniversityManagementSysDbContext context)
        {
            _context = context;
        }
        ...
        {
            var universityManagementSysDbContext = _context.Students.Include(s => s.Department);
        ...
        public async Task<IActionResult> Create([Bind("Id,Address,Dob,Fname,Lname,DepartmentId,Mail,Phone")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Address,Dob,Fname,Lname,DepartmentId,Mail,Phone")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UniversityManagementSysDbContext.Students'  is null.");
            }
            var student = await _context.Students.FindAsync(id);
            if (student != null)
            {
